...
public class RestrictionsDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtWin, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnSubmit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmit1ActionPerformed
        // TODO add your handling code here:
        String strRestrictions = this.getRestrictions();
    ...
    private void btnCRNRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCRNRemoveActionPerformed
        // TODO add your handling code here:
         if(!(txtCRN.getText()).isEmpty())
         {
             if(Classes.contains(txtCRN.getText()))
             {
             ...
             {
                 JOptionPane.showMessageDialog(this, "CRN # " + txtCRN.getText() + " doesn't exist in list.");
             }
        }
